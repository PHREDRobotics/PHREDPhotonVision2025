...
public class AlignLoadingStationCommand extends Command {
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber("Vision/AlignLoadingStationCommand/xSpeed", xSpeed);
    SmartDashboard.putNumber("Vision/AlignLoadingStationCommand/ySpeed", ySpeed);
    SmartDashboard.putNumber("Vision/AlignLoadingStationCommand/turningSpeed", turningSpeed);
    SmartDashboard.putString("Vision/AlignLoadingStationCommand/targetPose2d", targetPose2d.toString());
    SmartDashboard.putString("Vision/AlignLoadingStationCommand/currentPose2d", currentPose2d.toString());
  }
