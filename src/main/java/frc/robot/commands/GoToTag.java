...
public class GoToTag extends Command {
  ...
  // new Translation3d(1.0, 0.0, 0.0), new Rotation3d(0.0, 0.0, Math.PI));
  /**
  ...
  public void execute() {
    ...
    SmartDashboard.putNumber("Vision/GoToTag/xSpeed", xSpeed);
    SmartDashboard.putNumber("Vision/GoToTag/ySpeed", ySpeed);
    SmartDashboard.putNumber("Vision/GoToTag/turningSpeed", turningSpeed);
    SmartDashboard.putString("Vision/GoToTag/targetPose2d", targetPose2d.toString());
    SmartDashboard.putString("Vision/GoToTag/currentPose2d", currentPose2d.toString());
  }
