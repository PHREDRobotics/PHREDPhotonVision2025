...
/**
 * An abstract class the can be extended to allow calibrated retrieval of
 * each joystick axis by name.
 * 
 * @author zach
 *
 */
public abstract class FlightStick extends Joystick {
   ...
   * 
   * @param port         the port the joystick is assigned to in the driver
   *                     station
   ...
   */
  public abstract double getCorrectedThrottle();
